...
const WeatherInfo = () => {
  const { feelsLike, humidity, windspeed, precipitation } = useWeather();
  ...
  return (
    <ul className="grid grid-cols-2 sm:grid-cols-4 gap-6  justify-center items-center">
      <li className="bg-neutral-800 flex flex-col gap-6 p-5 rounded-xl min-w-45.5">
        ...
        <span className="text-[32px]/[1] font-light">{feelsLike}&deg;</span>
      </li>
      <li className="bg-neutral-800 flex flex-col gap-6 p-5 rounded-xl min-w-45.5">
      ...
      <li className="bg-neutral-800 flex flex-col gap-6 p-5 rounded-xl min-w-45.5">
        ...
        <span className="text-[32px]/[1] font-light">{windspeed} Km/h</span>
      </li>
      <li className="bg-neutral-800 flex flex-col gap-6 p-5 rounded-xl min-w-45.5">
        <p className="text-[18px]/[1.2] font-medium">Precipitation</p>
        <span className="text-[32px]/[1] font-light">{precipitation} mm</span>
      </li>
    </ul>
  );
};
