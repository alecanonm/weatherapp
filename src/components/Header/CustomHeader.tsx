...
import UnitsSwitcher from "../ui/UnitsSwitcher";
    ...
    <header className="flex  xl:px-28 backdrop-blur-md justify-between items-center text-neutral-0 font-dm-sans">
      ...
      <div>
        <button
          ...
          className="flex xl:gap-2.5 gap-1.5 bg-neutral-800 py-2 px-2.5 xl:py-3 xl:px-4 rounded-lg cursor-pointer">
          <img
            src={unitsIcon}
            alt="units"
          />
        ...
        {showUnits && (
          <div className="absolute xl:right-auto right-0 pt-2">
            <UnitsSwitcher />
          </div>
        )}
      </div>
